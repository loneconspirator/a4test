"""
Django settings for a4test project.
...
WSGI_APPLICATION = 'a4test.wsgi.application'
...
# Wagtail settings
WAGTAIL_SITE_NAME = "a4test"


# Authentification

AUTH_USER_MODEL = 'a4test_users.User'
...
A4_COMMENTABLES = (
    ...
    ('a4test_mapideas', 'mapidea'),


    ('a4test_documents', 'chapter'),
    ('a4test_documents', 'paragraph')
