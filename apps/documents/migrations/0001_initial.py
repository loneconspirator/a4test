# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-04-08 08:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='paragraphs', to='a4test_documents.Chapter')),
            ],
            options={
                'ordering': ('weight',),
            },
