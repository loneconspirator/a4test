...
class DocumentDashboardView(ProjectMixin,
    ...
    template_name = 'a4test_documents/document_dashboard.html'
...
class ChapterDetailView(ProjectMixin,
    ...
    permission_required = 'a4test_documents.view_chapter'
...
class ParagraphDetailView(ProjectMixin,
    ...
    permission_required = 'a4test_documents.view_paragraph'


class DocumentDashboardExportView(DashboardExportView):
    template_name = 'a4test_exports/export_dashboard.html'
